...
-- E-Commerce Website tasks (project_id = 1)
...
-- Task Management System tasks (project_id = 2)
...
-- Weather Dashboard tasks (project_id = 3)
...
-- Blog Platform tasks (project_id = 4)
...
-- Inventory Management tasks (project_id = 5)
