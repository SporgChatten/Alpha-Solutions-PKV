-- ======================================================
-- FAKE DATA FOR Alpha Solution PKV
-- ======================================================
...
-- ========== EMPLOYEES ==========
INSERT INTO employee (user_id, first_name, last_name, hourly_rate)
VALUES
...
-- ========== PROJECTS ==========
INSERT INTO project (name, description, start_date, end_date, budget, created_by)
VALUES
...
-- ========== TASKS ==========
INSERT INTO task (project_id, assigned_to, name, description, estimated_hours, actual_hours, cost, status)
VALUES
